...
define view ZTT_I_ISSUES
    ...
    association [0..*] to ZTT_I_ISSUE_TRANSPORT_REQUESTS as _transportRequest   on $projection.code                   = _transportRequest.issue_code
                                                                                 and $projection.project_code           = _transportRequest.project_code
    association [0..*] to ZTT_I_ISSUE_COMMENTS           as _comment            on $projection.code                   = _comment.issue_code
